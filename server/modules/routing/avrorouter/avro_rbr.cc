...
uint8_t* process_row_event_data(TableMap *map, TableCreate *create,
 ...
 */
uint8_t* process_row_event_data(TableMap *map, TableCreate *create, avro_value_t *record,
